...
echo "  2. .claude/docs/WEB_CONTEXT.md (Project context, current state)"
echo "  3. .claude/docs/BRD_Password_Encryption.md (Requirements)"
echo "  4. .claude/work-units/CURRENT.md (Current work unit)"
echo ""
echo "After reading all four files, report:"
echo "  ✅ Context loaded: [phase, current work]"
echo "  ✅ Ready to: [specific action based on user's request]"
echo "  OR"
echo "  ⚠️ Gap identified: [what's unclear]"
echo ""
