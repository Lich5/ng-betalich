...
echo "  3. .claude/docs/WEB_CONTEXT.md (Project context, current state)"
echo "  4. .claude/docs/BRD_Password_Encryption.md (Requirements)"
echo "  5. .claude/work-units/CURRENT.md (Current work unit)"
echo ""
